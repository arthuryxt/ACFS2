...
perl /Users/arthur/Desktop/Dev/acfs2//ACF_Step5_process_bt2aln.pl circRNA_candidates temp_circ.bwamap UNMAP_expr temp_circ_MEA temp_circ_CBR no 6 150 0.05
